...
window.SOURDOUGH_RECIPES = [
    {
      ...
      description:"Levain, autolyse, folds and final proof.",
      baseYield:2,
      yieldUnit:"loaves",
      ddtC:25.6,
      baseBakeOffset:1110,
    ...
    },
    {
      ...
      description:"High-rye dough with rye sour and a short bulk.",
      baseYield:2,
      yieldUnit:"loaves",
      ddtC:27.8,
      baseBakeOffset:900,
    ...
    },
    {
      ...
      description:"Levain dough with sprouted grains and an overnight retard.",
      baseYield:2,
      yieldUnit:"loaves",
      ddtC:25.6,
      baseBakeOffset:3060,
    ...
    },
    {
      ...
      description:"Pullman rye with sour, levain and an overnight soaker.",
      baseYield:1,
